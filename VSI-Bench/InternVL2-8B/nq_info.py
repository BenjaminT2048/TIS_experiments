...
# python /root/TIS/VSI-Bench/InternVL2-8B/nq_info.py --out /root/TIS/VSI-Bench/results/object_counting/pure_info.json --qtype object_counting
# python /root/TIS/VSI-Bench/InternVL2-8B/nq_info.py --out /root/TIS/VSI-Bench/results/object_abs_distance/pure_info.json --qtype object_abs_distance