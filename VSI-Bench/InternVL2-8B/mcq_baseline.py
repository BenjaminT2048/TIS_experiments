...
# ----------------------------
def main():
    ap = argparse.ArgumentParser(description="Run InternVL2 on VSI-Bench object_rel_direction (arkitscenes).")
    ...
    ap.add_argument("--video_dir", type=str, default="./arkitscenes", help="Folder that contains {scene_name}.mp4")
    ...
    ap.add_argument("--max_num_tiles", type=int, default=1, help="tiles per frame for InternVL2 dynamic preprocess")
...
if __name__ == "__main__":
    ...
    main()
# python InternVL2-8B/mcq_baseline.py --qtype object_rel_dir --out /root/TIS/VSI-Bench/results/object_rel_direction/baseline_16.json
# python InternVL2-8B/mcq_baseline.py --qtype object_rel_distance --out /root/TIS/VSI-Bench/results/object_rel_distance/baseline_16.json


# python InternVL2-8B/mcq_baseline.py --qtype object_rel_ --out /root/TIS/VSI-Bench/results/object_rel_distance_and_direction/baseline_16_cot.json
