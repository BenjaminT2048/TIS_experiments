...
def build_prompt(question: str, options_text: str, num_frames: int, qtype: str, cot: bool) -> str:
    """
...
def answer_on_video(
    ...
    prompt = build_prompt(question, options_text, num_frames=len(num_patches_list), qtype=qtype, cot=cot)
    response = model.chat(
        tokenizer,
        pixel_values,
        prompt,
...
def main():
    ...
    ap.add_argument("--cot", type=str, default=False)
    ...
    print(f"Done. Evaluated {n_total} with GT letters.")
...
# python VSI-Bench/InternVL-8B/baseline.py --out VSI-Bench/InternVL-8B/results/3.5/object_counting/baseline.json --qtype object_counting \
# --model_path OpenGVLab/InternVL3_5-8B

# python VSI-Bench/InternVL-8B/baseline.py --out VSI-Bench/InternVL-8B/results/3.5/object_abs_distance/baseline.json --qtype object_abs_distance \
# --model_path OpenGVLab/InternVL3_5-8B

# python VSI-Bench/InternVL-8B/baseline.py --out VSI-Bench/InternVL-8B/results/3.5/object_rel_direction/baseline.json --qtype object_rel_direction \
# --model_path OpenGVLab/InternVL3_5-8B

# python VSI-Bench/InternVL-8B/baseline.py --out VSI-Bench/InternVL-8B/results/3.5/object_rel_distance/baseline.json --qtype object_rel_distance \
# --model_path OpenGVLab/InternVL3_5-8B

# python VSI-Bench/InternVL-8B/baseline.py --out VSI-Bench/InternVL-8B/results/3.5/route_planning/baseline.json --qtype route_planning \
# --model_path OpenGVLab/InternVL3_5-8B

# python VSI-Bench/InternVL-8B/baseline.py --out VSI-Bench/InternVL-8B/results/3.5/route_planning/object_size_estimation.json --qtype object_size_estimation \
# --model_path OpenGVLab/InternVL3_5-8B
